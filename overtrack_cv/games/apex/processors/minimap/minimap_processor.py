...
from overtrack_cv.games.apex.processors.minimap.models import Location, RingsComposite
...
class MinimapProcessor(Processor):
    ...
    def process(self, frame: Frame):
        ...
        filtered_minimap, filtered_rings = [
            ...
            for p in self.model.predict(np.expand_dims(map_image, axis=0).astype(np.float32))
        ]
